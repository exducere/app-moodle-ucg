...
export const MOODLE_RELEASES = {
    ...
    '5.1': 2025100600,
    '5.2': 2026042000,
    '5.3': 2026060000, // @todo [5.3] replace with right value when released. Using a tmp value to be able to test new things.
};
...
export const enum CoreRefreshIcon {
    ...
    REFRESH = 'ucg-rotate-01',
};

export const enum CoreSyncIcon {
    LOADING = LOADING_ICON,
    SYNC = 'ucg-exchange-01',
};
...
export class CoreConstants {
     ...
     */
    static readonly ICON_NOT_DOWNLOADED = 'ucg-cloud-download';
    /**
