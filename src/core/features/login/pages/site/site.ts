...
export default class CoreLoginSitePage implements OnInit {
    ...
    readonly appVersion = CoreConstants.CONFIG.versionname;
    readonly institutionalSites = [
        {
            name: 'UCG ONE',
            category: 'Grado',
            description: 'Aula virtual para programas de grado y formación continua.',
            url: 'https://aulasucgone.casagrande.edu.ec',
            icon: 'ucg-graduation-cap',
            className: 'ucg-one',
        },
        {
            name: 'Posgrados',
            category: 'Posgrado',
            description: 'Campus virtual para maestrías y programas de posgrado.',
            url: 'https://aulaposgrados.casagrande.edu.ec',
            icon: 'ucg-book-open-01',
